        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerforemrId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongPerformers", x => new { x.SongId, x.PerforemrId });
                    table.ForeignKey(
                        name: "FK_SongPerformers_Performers_PerforemrId",
                        column: x => x.PerforemrId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongPerformers_PerforemrId",
